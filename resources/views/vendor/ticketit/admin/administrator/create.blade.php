                ...
                <tr>
                    <td>
                        <div class="form-check form-check-inline">
                            <input id="admin_{{$loop->index}}" name="administrators[]" type="checkbox" class="form-check-input" value="{{ $user->id }}" {!! $user->ticketit_admin ? "checked" : "" !!}>
                            <label for="admin_{{$loop->index}}" class="form-check-label">{{ $user->name }}</label>
                        </div>
                    </td>
                </tr>
            @endforeach
