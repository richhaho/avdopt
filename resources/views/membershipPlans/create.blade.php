            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12"><label for="tokens">Free Tokens:</label></div>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" name="tokens" id="tokens" value="{{ old('tokens') }}">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12"><label for="user_image_change">Time duration to change picture</label></div>
                                <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12"><label for="user_image_change">Max No of images upload by user</label></div>
                                <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-12 input-match-quest">
                                    <input type="number" placeholder="Max No of Match Questions" class="form-control" value="" name="websiteSettings[sub_match_quest_count]">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
