            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" method="POST" action="{{route('pushnotifications.store')}}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="button_text" type="text" class="form-control{{ $errors->has('button_text') ? ' is-invalid' : '' }}" name="button_text" value="Click Here">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="showing_count" type="text" class="form-control{{ $errors->has('showing_count') ? ' is-invalid' : '' }}" name="showing_count" value="{{ old('showing_count') ? old('showing_count'): 1 }}">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <input id="seconds_to_show_after_login" type="text" class="form-control{{ $errors->has('seconds_to_show_after_login') ? ' is-invalid' : '' }}" name="seconds_to_show_after_login" value="{{ old('seconds_to_show_after_login') }}">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 demo-checkbox">
                                        <input type="checkbox" id="show_to_new_users" class="filled-in chk-col-red" checked="checked" name="show_to_new_users">
