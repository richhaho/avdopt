                ...
                <div class="container-fluid">
                  <div class="tab-content">
                        <div id="inbox" class="tab-pane fade in active">
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="{{route('usergroup.store')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="title"  type="text" class="form-control" name="title" value="{{ old('heading') }}" required autofocus>
                        </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="agegroup"  type="number" class="form-control" name="agegroup" value="{{ old('heading') }}" required autofocus>
                        </div>
                        </div>
                         ...
                         <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="agegroup"  type="number" class="form-control" name="maxage" value="{{ old('heading') }}" required autofocus>
                        </div>
                        </div>
