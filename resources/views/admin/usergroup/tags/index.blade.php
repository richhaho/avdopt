                ...
                <div class="row">
                    <div class="col-12">
                       <h3 class="inline_block font22"><b class="vertical_align"><img src="{{ asset('backend/images/taguser.png') }}" alt="Img" title="Img" class="announcement">TAGS</b>                  
                           <a href="{{route('admin.usergroup.tag.create')}}" class="btn btn-success pull-right">Add Tag</a>
                       </h3>  
                       <hr>
                               ...
                               <div class="table-responsive m-t-40">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$tag->title}}</td>
                                        <td><div style="float: left;margin: 0 10px;height:30px;width:30px;background:{{$tag->primary_color}}"></div><div style="float: left;margin: 0 10px;height:30px;width:30px;background:{{$tag->secondary_color}}"></div></td>
                                        <td>
