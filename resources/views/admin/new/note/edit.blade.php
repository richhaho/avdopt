    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block font20"><i class="fa fa-envelope"></i> Edit Note                  
                            <a href="{{route('usergroup.notes', $groupId)}}" class="btn btn-info pull-right">Back</a>
                        </h3>
                        <hr>
                        @if (session('success'))
                        ...
                        <form class="form_inline fullwidth mtop40" method="POST" action="{{route('note.update', $note->id)}}">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <label for="note" class="col-md-3 col-form-label text-md-right"> Note Title</label>
                                    <div class="col-md-9">
