                ...
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Create Tag</b>
                            <a class="btn btn-info pull-right" href="{{ url('admin/new/myfun') }}"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                        <hr>
                        @if (session('success'))
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" method="POST" action="{{route('store.myfun')}}">
                            @csrf
