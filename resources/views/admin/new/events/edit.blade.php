    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b> Edit Event</b>
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" method="POST" action="{{route('event.update', $event->id)}}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ @$event->title }}" required >
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <textarea id="description" class="{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="" style="width:100%">{{ @$event->content }}</textarea>
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                @if($event->image)
                                        <img id="blah" src="/images/events/{{ $event->image }}" alt="cat-image" />
                                @else
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="datepicker" type="text" class="form-control{{ $errors->has('date') ? ' is-invalid' : '' }}" name="date"
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="location_url" type="text" class="form-control{{ $errors->has('location_url') ? ' is-invalid' : '' }}" name="location_url" value="{{ $event->location_url }}">
                            </div>
                            </div>
                        </div>
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-8">
                                <input id="price" type="text" class="form-control{{ $errors->has('price') ? ' is-invalid' : '' }}" name="price" value="{{ $event->price }}">
                            </div>
                            </div>
                        </div>
                        <div class="form-group">
                           <div class="row">
                            <label for="FreeTokens" class="col-md-4 col-form-label text-md-right">{{ __('Free Tokens') }}</label>

                            <div class="col-md-8">
                                <input id="freetokens" type="text" class="form-control{{ $errors->has('freetokens') ? ' is-invalid' : '' }}" name="freetokens" value="{{ $event->free_tokens }}">
                            </div>
                            </div>
                        </div>
                        <div class="form-group">
