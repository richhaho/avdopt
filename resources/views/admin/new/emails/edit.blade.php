    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                    	<h3 class="inline_block"><b>Emails</b>
						...
						<div class="form-group">
                           <div class="row">
						   <label for="subject" class="col-md-2 col-form-label text-md-right">{{ __('Title or Subject') }}</label>
                            <div class="col-md-10">
						...
						<div class="form-group">
                            <div class="row">
								<label for="content" class="col-md-2 col-form-label text-md-right">{{ __('Email Text') }}</label>
								<div class="col-md-10">
