            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a class="btn btn-info pull-right" href="{{ url('admin/tokens') }}"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                        <hr>
                        @if (session('message'))
                        ...
                        <div class="form-group">
                           <div class="row">
                            ...
                            <div class="col-md-10">
                                <input id="description" type="text" class="form-control{{ $errors->has('description') ? ' is-invalid' : '' }}" name="description" value="{{ $token->description }}" >
