                ...
                <div class="row">
                    <div class="col-12">
                     <h3 class="font22 inline_block">
                      ...
                      <a href="{{route('admin.species.index')}}" class="btn btn-success pull-right">Back</a>
                      </h3><hr>
                           <form class="form-horizontal" role="form" method="POST" action="{{route('admin.species.store')}}">
                                        ...
                                        <div class="row">
                                            <label for="species_name" class="col-xs-12 col-sm-4 col-md-3 col-lg-3 col-xl-4 col-form-label text-md-right">
                                                Species Name
                                            </label>
