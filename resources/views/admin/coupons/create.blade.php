    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b>Add Coupon</b>
                            <a class="btn btn-primary pull-right" href="{{ route('coupons.index') }}"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                        <hr>
                        @if (session('success'))
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" action="{{ route('coupons.store') }}"
                              method="post">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="coupon_count" placeholder="Coupon Count" value="{{ old('coupon_count') }}">
                                    </div>
                                    <br> <br>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 demo-radio-button discount_types">
                                        @foreach($coupon_discount_types as $row)
                                            <input name="discount_type" type="radio" id="{{ $row->slug }}" value="{{ $row->id }}">
                            ...
                            <div class="form-group discount-types token_off both">
                                <div class="row">
                                    <label for="token_amt" class="col-md-4 col-form-label text-md-right">Token Amount</label>
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="token_amt" placeholder="Token Amount" value="{{ old('token_amt') }}">
                                    </div>
                                    <br> <br>
                            ...
                            <div class="form-group discount-types discount_percentage both">
                                <div class="row">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                    <input type="text" class="form-control" name="expiry_date" placeholder="Expiry Date" id="js-date" value="{{ old('expiry_date') }}">
                                    </div>
                                    <br> <br>
