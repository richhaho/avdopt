    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3><i class="fa fa-map-marker" aria-hidden="true"></i> Add Trial Location</h3>
                        <hr>
                        <form class="form-horizontal form_common" role="form" method="POST" action="{{route('triallocation.store')}}"  enctype="multipart/form-data">
                            {{ csrf_field() }}
