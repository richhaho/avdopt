    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                         <h3 class="inline_block font22"><b><img src="{{ asset('backend/images/setamount.png') }}" alt="Img" title="Img" class="announcement">Feature Price</b></h3>
                         <hr>
                ...
                <div class="token-amount">
                    <form class="form_inline fullwidth" method="POST" action="{{ route('saveWebsiteSetting') }}">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btnpad btn-success pull-right border_radius">Submit</button>
                        </div>
                    </form>
                </div>
                    </div>
