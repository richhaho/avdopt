    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3><i class="fa fa-edit" aria-hidden="true"></i> Add Trial Reason</h3>
                        <hr>
                        <form class="form-horizontal form_common" role="form" method="POST" action="{{route('trialreasons.store')}}"  enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group{{ $errors->has('sort') ? ' has-error' : '' }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="sort"  type="number" min='0' class="form-control" name="sort" value="{{ old('sort') }}" required autofocus>
                                    </div>
                                </div>
                            </div>
                            @if ($errors->has('sort'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <select name="status" class="form-control">
                                            ...
                                            <option value="adoption">Proceed to Adoption</option>
