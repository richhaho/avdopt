    ...
    <div class="col-lg-12 col-xlg-12">
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <h3 class="inline_block"><b class="vertical_align">Create Advertisement</b>
                        ...
                        @endif
                        <form class="form_inline fullwidth mtop40" method="POST" action="{{route('advertisement.store')}}">
                            @csrf
                            <div class="row"> 
                                    ...
                                    <div class="col-md-10 selectbanner">
                                        <select class="form-control" name="banner[]" multiple="multiple" id="banner">
                                            @foreach($banner as $banner)
                                                <option value="{{$banner->id}}">{{$banner->banner_width}}X{{$banner->  banner_height}} : {{$banner->page_location}} page</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-10 selecttarget">
                                        <select class="form-control" name="targetaudience[]" multiple="multiple" id="targetaudience">
                                            @foreach($targetaudience as $targetaudience)
                                                <option value="{{$targetaudience->id}}">{{$targetaudience->usergroup_names}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="custom-control custom-radio" style="padding-left: 0px; float: left;">
                                        <input type="radio" class="custom-control-input" id="weekly" name="banner_plan" value="weekly">
                                        <label class="custom-control-label" for="weekly">Weekly</label>
                                     </div>
                                     <div class="custom-control custom-radio" style="padding-left: 0px; float: left;">
                                         <input type="radio" class="custom-control-input" id="monthly" name="banner_plan" value="monthly">
                            ...
                            <div class="row">                               
                                ...
                                <div class="col-md-10 form-group">
                                    <input type="number" name="plan_period" id="plan_period" class="form-control" value="{{ old('plan_period') }}">
                                </div>
                            </div> 
                            <div class="form-group">
                                <div class="row">
