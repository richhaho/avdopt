                                   ...
                                   <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <a style="background-color: #f7d320;border-color: #f7d320;" title="Unfeature" href="{{ route('event.unfeature', $event->id)}}" class="btn btn-info btn-circle"><i class="fa fa-star" aria-hidden="true"></i></a>
                                                @endif
