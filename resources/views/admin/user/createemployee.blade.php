            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <a class="btn btn-info btnpad pull-right" href="{{ route('users.employee') }}"><i class="fa fa-arrow-left"></i> Back</a>
                        </h3>
                        <hr>
                @if (session('success'))
                    ...
                    <form class="form_inline fullwidth mtop40" method="POST" action="{{route('users.storeemployee')}}">
                        ...
                        <div class="form-group">
                            <div class="row">
                            <label for="catagory" class="col-md-4 col-form-label text-md-right">Staff</label>
                            <div class="col-md-8">
