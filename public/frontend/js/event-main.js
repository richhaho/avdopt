                ...
                success: function (response) {
                    ...
                    if (response.success) {
                        ...
                        if (response.msg == 'Event saved successfully.') {
                                ...
                                save_event_obj.attr("title","Unsave Event");
                                save_event_obj.children().attr("src","images/remove-bookmark.png");
                        }
                        else {
                            save_event_obj.attr("title","Save Event");
                            save_event_obj.removeClass('saved');
                            save_event_obj.children().attr("src","images/add-bookmark.png");
                        }
                    }
                    else {
